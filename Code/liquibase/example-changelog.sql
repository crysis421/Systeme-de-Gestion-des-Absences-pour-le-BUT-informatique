...
--changeset Kilian:15
DROP table if exists JustificatifEtTraitementJustificatif;
...
--changet Kilian:16
Alter table TraitementJustificatif add column if not exists idJustificatif INT REFERENCES Justificatif (idJustificatif);
