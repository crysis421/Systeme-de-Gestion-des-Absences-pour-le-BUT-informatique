...
<div id="infos">
    ...
    <input style="width: 250px" type="text" id="numeroE" name="numeroE" placeholder="entrer votre numéro d'étudiant"><br>
    <br>

    <label for="filiere">Filière/Formation *: </label>
    <input type="text" id="filiere" name="filiere" placeholder="entrer votre filière"><br>
    <br>

    <label for="annee">Année d'études *: </label>
    <input type="text" id="annee" name="annee" placeholder="1ere année "><br>
    <br>

    <label for="mail">Adresse mail *: </label>
    <input type="email" id="mail" name="mail" placeholder="entrer votre adresse mail"><br>
    <br>

    <label for="numero">Numéro de téléphone : </label>
    <input type="tel" id="numero" name="numero" placeholder="entrer votre votre numéro de téléphone"><br>
    <br>
</div>
...
<div id="infoAbsence">
    ...
    <input type="text" id="nom2" name="nom2"> a été absent :</label><br>
    <br>
    <label for="datedebut"> Du :</label>
    <input type="date" id="datedebut" name="datedebut">

    <label for="heuredebut"> de :</label>
    <input type="time" id="heuredebut" name="heuredebut"><br>
    <br>
