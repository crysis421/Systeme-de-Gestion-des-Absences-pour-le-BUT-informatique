...
<head>
    ...
    <link rel="stylesheet" href="../CSS/connect/connectMarron.css">
...
<main>
    ...
    <div id="container">
        <form id="form" action="../Presentation/connexion.php" method="post">
            ...
            <a style="font-family: Arial; color: yellow; font-size: 11px;" href="MDPoublierEtudiant.php">Mot de passe oublié ?</a><br><br>
